...
{
    internal class MatrixOperations_Determinant_A
    {
        public static void MatricesDeterminantA(TextBox[,] matrixTextBoxes, int rowCount, int columnCount,  Panel panel)
        {
            try
            {
                int rowsA = rowCount;
                ...
                double determinant = CalculateDeterminant(matrixA, rowsA);
