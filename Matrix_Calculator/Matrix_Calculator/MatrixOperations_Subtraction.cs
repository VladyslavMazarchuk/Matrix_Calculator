...
{
    internal class MatrixOperations_Subtraction
    {
        public static void SubtractMatrices(TextBox[,] matrixTextBoxes, TextBox[,] matrixTextBoxesB, int rowCount, int columnCount, int rowCountB, int columnCountB, Panel resultPanel)
        {
            try
            {
                int rowsA = rowCount;
            ...
            {
                MessageBox.Show($"Під час віднімання матриць сталася помилка: {ex.Message}");
            }
        }
